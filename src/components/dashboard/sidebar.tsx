...
export default function Sidebar({
  ...
  const sortedTeams = [...teams].sort((a, b) => a.index - b.index).reverse();
    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          {/* Sidebar */}
          <motion.div
            className="fixed w-[80%] md:sticky md:w-full md:max-w-3xs lg:max-w-sm top-0 left-0  h-screen  bg-card border border-border rounded-r-xl md:rounded-xl shadow-xl z-50 md:z-auto overflow-y-auto"
          ...
          >
            <div className="flex flex-col h-full border-r border-border bg-card">
              <div className="flex flex-col h-full overflow-y-auto">
                ...
                <div className="p-4 border-b border-border rounded-t-xl top-0 z-10 bg-muted sticky">
                ...
                <div className="p-4 space-y-3">
                  {sortedTeams.map((team) => {
                    const isCurrentlyViewed =
                      currentViewedTeamId === team.team_id;
